...
`moc_schema_faz_m_email_onay.sql`
Çalıştırılsaydı diğer modüllerin dallarını **sessizce silecekti** (7 daldan **6'sı**).

**Bu modülün onay mantığı artık:** `public.moc_onay_uygula()`
...
- 23.09.2026 devamı: `MOC.html` proje detayına liste/Kanban (sürükle veya durum seç) ve milestone oluşturma/tamamlama eklendi. Görev iptal sütunu kaybolmuyor; mobilde yatay kaydırma ve durum seçimi var. Kapanış engelleme kuralı bu dilimde uygulanmadı.
